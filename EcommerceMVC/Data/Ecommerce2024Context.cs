...
public partial class Ecommerce2024Context : DbContext
{
    public Ecommerce2024Context()
    {
    }

    public Ecommerce2024Context(DbContextOptions<Ecommerce2024Context> options)
        : base(options)
    {
    }
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=MSI;Initial Catalog=Ecommerce2024;Persist Security Info=True;User ID=sa;Password=123456;Encrypt=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<NhanVien>(entity =>
        {
            ...
            entity.HasOne(d => d.MaPbNavigation).WithMany(p => p.NhanViens)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PhongBan_NhanVien");
        });
